...
def exchangeable_value(
    ...
    """
    spread_as_float = spread / 100
    full_exchange_rate = spread_as_float + exchange_rate
    money_converted = exchange_money(budget, full_exchange_rate)
    number_of_bills = get_number_of_bills(money_converted, denomination)
